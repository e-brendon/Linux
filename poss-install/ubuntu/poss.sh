...
sleep 5
sudo apt install tilix vlc build-essential libglib2.0-dev dconf-cli cmake pkg-config libevdev-dev libudev-dev libconfig++-dev libglib2.0-dev flatpak virtualbox virtualbox-dkms -y 
clear
